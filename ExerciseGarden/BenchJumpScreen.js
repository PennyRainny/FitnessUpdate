...
export default function BenchJumpScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      style={styles.card}>
        <Image 
        source={require('../assets/BenchJump.png')} style={styles.exerciseImage} 
        />
        <Text style={styles.title}>Bench Jump</Text>
        <Text style={styles.line}></Text>
        <Text style={styles.subTitle}>วิธีทำ:</Text>
        <Text style={styles.description}>
        •	หาม้านั่งหรือขอบปูน → ย่อตัวลง → กระโดดขึ้นไปยืนบนม้านั่ง	{'\n'}
        •	ลงเบา ๆ แล้วทำซ้ำ {'\n'}
