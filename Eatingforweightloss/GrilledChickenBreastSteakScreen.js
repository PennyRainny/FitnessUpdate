...
export default function GrilledChickenBreastSteakScreen({ navigation, route }) {
  ...
  const item = {
    ...
    name: 'สเต็กอกไก่ย่าง',
    kcal: '350 Kcal',
    screen: 'GrilledChickenBreastSteakScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/GrilledChickenBreastSteak.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 350 Kcal</Text>
      </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 3.6 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 31 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
       <Text style={styles.nutriText}>🍞 0 g carbo</Text>
      </View>
    </View>
    <Text style={styles.Descriptions}>Descriptions</Text>
    <Text style={styles.descriptionText1}> 
    เวลาในการรับประทาน: {'\n'}
    เหมาะสำหรับมื้อหลักหลังการออกกำลังกาย  {'\n'}
    เพื่อเสริมสร้างและซ่อมแซมกล้ามเนื้อ​  {'\n'}
    </Text>
