...
export default function SukiyakisoupScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Sukiyakisoup.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 260 Kcal</Text>
      </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 5 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 10 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
    ...
    เวลาในการรับประทาน: {'\n'}
    สามารถรับประทานก่อนการออกกำลังกาย 1-2   {'\n'}
    ชั่วโมง เพื่อให้พลังงานจากคาร์โบไฮเดรต   {'\n'}
    และโปรตีนช่วยรักษามวลกล้ามเนื้อ {'\n'}
    </Text>
