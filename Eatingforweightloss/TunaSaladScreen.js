...
export default function TunaSaladScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/TunaSalad.png')} style={styles.image} />
    ...
    เนื่องจากมีโปรตีนสูงและไขมันต่ำ    {'\n'}
    ช่วยในการลดน้ำหนัก​ {'\n'}
    </Text>
