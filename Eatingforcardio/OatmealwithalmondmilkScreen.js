...
export default function OatmealwithalmondmilkScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '2',
    name: 'ข้าวโอ๊ตกับนมอัลมอนด์',
    kcal: '200 Kcal',
    screen: 'OatmealwithalmondmilkScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Oatmealwithalmondmilk.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 200 Kcal</Text>
      </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 5 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 7 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
       <Text style={styles.nutriText}>🍞 35 g carbo</Text>
      </View>
    </View>
    <Text style={styles.Descriptions}>Descriptions</Text>
    <Text style={styles.descriptionText1}> 
    เวลาในการรับประทาน: {'\n'}
    ควรรับประทานก่อนการออกกำลังกาย 1-2 ชั่วโมง    {'\n'}
    เนื่องจากคาร์โบไฮเดรตเชิงซ้อนจากข้าวโอ๊ตให้พลังงานที่ยาวนาน   {'\n'}
    และโปรตีนช่วยสนับสนุนการทำงานของกล้ามเนื้อ ​  {'\n'}
    </Text>
