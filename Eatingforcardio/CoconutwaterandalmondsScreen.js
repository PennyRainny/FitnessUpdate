...
export default function CoconutwaterandalmondsScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '5',
    name: 'น้ำมะพร้าวและอัลมอนด์',
    kcal: '200 Kcal',
    screen: 'CoconutwaterandalmondsScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Coconutwaterandalmonds.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 200 Kcal</Text>
        ...
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 4 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 2 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
       <Text style={styles.nutriText}>🍞 15 g carbo</Text>
      </View>
    </View>
