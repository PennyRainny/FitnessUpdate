...
export default function EatingtogainmusclsScreen({ navigation, route }) {
  ...
  const foodMenu = [
  { id: '1', name: 'กล้วยกับเนยถั่ว', kcal: '250 Kcal', screen: 'BananaandpeanutbutterScreen' },
  { id: '2', name: 'ข้าวโอ๊ตกับนมอัลมอนด์', kcal: '200 Kcal', screen: 'OatmealwithalmondmilkScreen' },
  { id: '3', name: 'แซนด์วิชขนมปังโฮลเกรนกับไข่', kcal: '300 kcal', screen: 'WholeGrainBreadandEggSandwichScreen' },
  { id: '4', name: 'พริกหยวกยัดไส้ข้าวกล้อง', kcal: ' 250 Kcal', screen: 'StuffedBellPepperswithBrownRiceScreen' },
  { id: '5', name: 'น้ำมะพร้าวและอัลมอนด์', kcal: '200 Kcal', screen: 'CoconutwaterandalmondsScreen' },
  ];
