...
export default function BananaandpeanutbutterScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '1',
    name: 'กล้วยกับเนยถั่ว',
    kcal: '250 Kcal',
    screen: 'BananaandpeanutbutterScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Bananaandpeanutbutter.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 250 Kcal</Text>
        ...
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 8 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 5 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
    ...
    เวลาในการรับประทาน: {'\n'}
    ควรรับประทานก่อนการออกกำลังกาย 30-60 นาที   {'\n'}
    เนื่องจากคาร์โบไฮเดรตจากกล้วยให้พลังงานที่รวดเร็ว  {'\n'}
    และไขมันกับโปรตีนจากเนยถั่วช่วยให้พลังงานยาวนาน​ {'\n'}
    </Text>
