...
export default function GrilledSalmonOnigiriwithSaltScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '2',
    name: 'โอนิกิริแซลมอนย่างเกลือ',
    kcal: '250 Kcal',
    screen: 'GrilledSalmonOnigiriwithSaltScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/GrilledSalmonOnigiriwithSalt.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 250 Kcal</Text>
        ...
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 8 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
    ...
    เวลาในการรับประทาน: {'\n'}
    ก่อนการออกกำลังกาย    {'\n'}
    1-2 ชั่วโมง เพื่อให้พลังงานจากคาร์โบไฮเดรต​​  {'\n'}
    </Text>
