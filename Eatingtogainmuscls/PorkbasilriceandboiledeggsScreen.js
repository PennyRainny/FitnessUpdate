...
export default function PorkbasilriceandboiledeggsScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '1',
    name: 'ข้าวกะเพราหมู และ ไข่ต้ม',
    kcal: '530 Kcal',
    screen: 'PorkbasilriceandboiledeggsScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Porkbasilriceandboiledeggs.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 530 Kcal</Text>
      </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 25 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 30 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
       <Text style={styles.nutriText}>🍞 70 g carbo</Text>
      </View>
    </View>
    ...
    เวลาในการรับประทาน: {'\n'}
    หลังการออกกำลังกาย    {'\n'}
    เพื่อเติมเต็มพลังงานและโปรตีนสำหรับการฟื้นฟูกล้ามเนื้อ​  {'\n'}
    </Text>
