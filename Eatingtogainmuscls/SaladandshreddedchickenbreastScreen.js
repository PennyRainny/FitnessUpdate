...
export default function SaladandshreddedchickenbreastScreen({ navigation, route }) {
  const [isFavorite, setIsFavorite] = useState(false);

  const item = {
    id: '4',
    name: 'ผักสลัด และ อกไก่ฉีก',
    kcal: '125 Kcal',
    screen: 'SaladandshreddedchickenbreastScreen',
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/Saladandshreddedchickenbreast.png')} style={styles.image} />
      ...
      <Text style={styles.nutriText}>🔥 125 Kcal</Text>
      </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍳 3.1-3.74 g fats</Text>
        </View>
        <View style={styles.nutriBox}>
        <Text style={styles.nutriText}>🍗 23.5-34.1 g proteins</Text>
        </View>
        <View style={styles.nutriBox}>
       <Text style={styles.nutriText}>🍞 3-4 g carbo</Text>
      </View>
    </View>
    ...
    →ให้พลังงานและโปรตีนสำหรับการทำงานของกล้ามเนื้อ  หลังออกกำลังกาย   {'\n'}
    →ช่วยซ่อมแซมกล้ามเนื้อและเติมสารอาหารที่จำเป็น    {'\n'}
    </Text>
