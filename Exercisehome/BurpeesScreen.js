...
export default function BurpeesScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      style={styles.card}>
        <Image 
        source={require('../assets/Burpees.png')} style={styles.exerciseImage} 
        />
      ...
      <TouchableOpacity  onPress={() => navigation.navigate('CountdownScreen')}>
